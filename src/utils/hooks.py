...
class CollectActAndGrad:
    ...
    def __exit__(self, type, value, traceback):
        ...
        self.grads = {}
        for n, module in trainable_modules(self.model):
            self.acts[n] = module.saved_acts
            self.grads[n] = module.saved_grads
...
# forget_loss=14.5403, disruption_loss=18.0576
# forget_loss=14.5816, disruption_loss=18.0585
# forget_loss=14.6472, disruption_loss=18.0590
# forget_loss=14.6961, disruption_loss=18.0616
# forget_loss=14.7479, disruption_loss=18.0566
# forget_loss=14.8189, disruption_loss=18.0598
# forget_loss=14.8686, disruption_loss=18.0641
# forget_loss=14.9267, disruption_loss=18.0590
# forget_loss=14.9823, disruption_loss=18.0598
# forget_loss=15.0445, disruption_loss=18.0723
# time taken: 48.87s